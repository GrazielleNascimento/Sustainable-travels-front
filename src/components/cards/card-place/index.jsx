...
const CardPlace = ({ place, isSelected, onClick }) => {
    
    const { imageUrl, name, type, description, location } = place;
    ...
    return (
        ...
        <CardContent>
            ...
            {description && <Detail><strong>Description:</strong> {description}</Detail>}
        </CardContent>
        </CardContainer>
    );
}
